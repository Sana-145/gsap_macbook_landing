...
const ModelSwitcher = ({scale, isMobile}) => {
    ...
    //useGSAP() - a custom hook coming from gsap react, making it easier to work with gsap within jsx component
    useGSAP(() => {
        if (showLargeMacbook) {
    ...
    const controlsConfig = {
        ...
        config: {mass: 1, tension: 0, friction: 26} // setting some additional physics
    }
    return (
        <>
