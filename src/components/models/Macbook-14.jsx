...
Files: macbook-14.glb [629.72KB] > D:\Pro__Ject\macbook_gsap_app\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if (child.isMesh) {
                // Change color only if the part name is NOT in noChangeParts list
